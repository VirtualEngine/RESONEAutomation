@{
    ...
    Description = 'RES ONE Automation composite DSC resources. These DSC resources are provided AS IS, and are not supported through any means.';
    DscResourcesToExport = @('ROAAgent', 'ROAConsole', 'ROADatabase', 'ROADatabaseAgent', 'ROADispatcher', 'ROALab');
    PrivateData = @{
        PSData = @{
